...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut___A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h35a7aceaa5efa6d6: (a: number, b: number, c: number) => void;
